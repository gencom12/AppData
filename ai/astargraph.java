...
class Node {
    ...
    double cost;
    boolean visited;
    Node parent; // To store the parent node for each node in the path
    List<Edge> neighbors;
...
public class astargraph {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numEdges; i++) {
            ...
            char sourceLabel = scanner.next().charAt(0);
            char targetLabel = scanner.next().charAt(0);
        ...
        char startLabel = scanner.next().charAt(0);
        System.out.print("Enter the goal vertex label: ");
        char goalLabel = scanner.next().charAt(0);
